...
class MechanicalWorkCommandAddDiaryScreen extends StatefulWidget {
  final MechanicalWorkCommand mechanicalWorkCommand;

  MechanicalWorkCommandAddDiaryScreen({
    this.mechanicalWorkCommand,
  });

  @override
  State<StatefulWidget> createState() =>
      _MechanicalWorkCommandAddDiaryScreenState();
}

class _MechanicalWorkCommandAddDiaryScreenState
    extends State<MechanicalWorkCommandAddDiaryScreen> {
  TextEditingController workDiaryTextController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Bổ sung nhật ký công tác"),
        ),
        body: SafeArea(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                "Danh sách nhật ký công tác : ${model.detailData.danhSachNhatKyCongTac.length}",
                                style: kDefaultTextStyle.copyWith(
                                    fontWeight: FontWeight.w500),
                              ),
                            ),
                            AddButton(
                                onTapButton: () => showAddDiaryDialog(context)),
                          ],
                        ),
                      ),
                      Expanded(
                                  ...
                                  itemPairsData: [
                                    {
                                      'icon': 'ic_page',
                                      'content':
                                          'Nhật ký công tác : ${model.detailData.danhSachNhatKyCongTac[index].nhatKyCongTac}',
                                    },
                                    {
                                      'icon': 'ic_clock',
                                      'content':
                                          'Thời gian bắt đầu : ${model.detailData.danhSachNhatKyCongTac[index].thoiGianBatDau.toDate(Constant.ddMMyyyyHHmm2)}',
                                    },
                                    {
                                      'icon': 'ic_clock',
                                      'content':
                                          'Thời gian kết thúc : ${model.detailData.danhSachNhatKyCongTac[index].thoiGianKetThuc.toDate(Constant.ddMMyyyyHHmm2)}',
                                    },
                                  ],
  ...
  Future<void> showAddDiaryDialog(BuildContext context) async {
    workDiaryTextController.clear();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextField(
                        controller: workDiaryTextController,
                        decoration: InputDecoration(
                          border: UnderlineInputBorder(),
                          labelText: 'Nhật ký công tác	',
                        ...
                        style: ButtonStyle(
                            ...
                            shape: MaterialStateProperty.all<
                                ...
                                RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(color: kBlue1)))),
                        onPressed: () async {
                          if (workDiaryTextController.text.isEmpty) {
                            ToastMessage.show(
                                'Nhật ký không để trống', ToastStyle.error);
                            return;
                          }
  ...
  @override
  void dispose() {
    workDiaryTextController.dispose();
