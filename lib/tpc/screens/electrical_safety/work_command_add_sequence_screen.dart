                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                "Danh sách trình tự công việc: ${model.detailData.danhSachTrinhTuCongViec.length}",
                                  ...
                                  itemPairsData: [
                                    {
                                      ...
                                      'content':
                                          'Trình tự thao tác : ${model.detailData.danhSachTrinhTuCongViec[index].trinhTuThaoTac}',
                                    },
                                    {
                                      'icon': 'ic_safety_conditional',
                                      'content':
                                          'Điều kiện an toàn : ${model.detailData.danhSachTrinhTuCongViec[index].dieuKienAnToan}',
                                    },
                                    {
                                      'icon': 'ic_clock',
                                      'content':
                                          'Thời gian bắt đầu : ${model.detailData.danhSachTrinhTuCongViec[index].thoiGianBatDau.toDate(Constant.ddMMyyyyHHmm2)}',
                                    },
                                    {
                                      'icon': 'ic_clock',
                                      'content':
                                          'Thời gian kết thúc : ${model.detailData.danhSachTrinhTuCongViec[index].thoiGianKetThuc.toDate(Constant.ddMMyyyyHHmm2)}',
                                    },
                                  ],
